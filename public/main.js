...
module.exports = "<div class=\"container\">\n  <h2>{{ title }}</h2>\n  <hr>\n  <div class=\"alert alert-danger\" *ngIf=\"status == 'error' \">\n\t\tPlease check email/password\n  </div>\n  <div class=\"alert alert-danger\" *ngIf=\"status == 'remenber' \">\n\t\tI remember you, if you want connect to admin\n  </div>\n  \n  <form #loginForm=\"ngForm\" (ngSubmit)=\"onSubmit()\">\n    <div class=\"form-group row\">\n      <label for=\"inputEmail3\"\n       class=\"col-sm-2 col-form-label\">Email</label>\n      <div class=\"col-sm-6\">\n        <input type=\"email\"\n              name=\"email\"\n              #email=\"ngModel\"\n              [(ngModel)]=\"user.email\"\n              class=\"form-control\"\n              required\n              pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$\"\n              placeholder=\"Email\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"inputPassword3\"\n             class=\"col-sm-2 col-form-label\">Password</label>\n      <div class=\"col-sm-6\">\n        <input type=\"password\"\n               class=\"form-control\"\n                name=\"password\"\n                #password=\"ngModel\"\n                [(ngModel)]=\"user.password\"\n                required\n                placeholder=\"Password\">\n      </div>\n    </div>\n\n    <div class=\"form-group row\">\n      <div class=\"col-sm-10\">\n        <button \n          type=\"submit\"\n          class=\"btn btn-primary\"\n          [disabled]=\"!loginForm.form.valid\">Log In</button>\n      </div>\n    </div>\n  </form>\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <div class=\"jumbotron\">\n        <ul>\n          <li>Temporarily, everyone signs up.<br>\n            In the future only the admin will be responsible for registering a new employee.<br>\n            <button type=\"button\" class=\"btn btn-link\" (click)=\"newUser()\">New User? Click me</button></li>\n          <li>If you have any problem to enter or forgot your password, please contact me by email.</li>\n          <li>How does it work? go to the page <button type=\"button\" class=\"btn btn-link\" (click)=\"sendToAbout()\">About me.</button></li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n<app-footer></app-footer>\n\n<!--<div class=\"col-log-5\">\n  <h1>{{ title }}</h1>\n  <hr>\n\n  <div class=\"alert alert-danger\" *ngIf=\"status == 'error' \">\n\t\tPlease check email/password\n  </div>\n  <div class=\"alert alert-danger\" *ngIf=\"status == 'remenber' \">\n\t\tI remember you, if you want connect to admin\n\t</div>\n\n  <form #loginForm=\"ngForm\" (ngSubmit)=\"onSubmit()\">\n      <div class=\"form-group row\">\n        <label for=\"inputEmail3\"\n         class=\"col-sm-2 col-form-label\">Email</label>\n        <div class=\"col-sm-6\">\n          <input type=\"email\"\n                name=\"email\"\n                #email=\"ngModel\"\n                [(ngModel)]=\"user.email\"\n                class=\"form-control\"\n                required\n                pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$\"\n                placeholder=\"Email\">\n        </div>\n      </div>\n      <div class=\"form-group row\">\n        <label for=\"inputPassword3\"\n               class=\"col-sm-2 col-form-label\">Password</label>\n        <div class=\"col-sm-6\">\n          <input type=\"password\"\n                 class=\"form-control\"\n                  name=\"password\"\n                  #password=\"ngModel\"\n                  [(ngModel)]=\"user.password\"\n                  required\n                  placeholder=\"Password\">\n        </div>\n      </div>\n\n      <div class=\"form-group row\">\n        <div class=\"col-sm-10\">\n          <button \n            type=\"submit\"\n            class=\"btn btn-primary\"\n            [disabled]=\"!loginForm.form.valid\">Log In</button>\n            <br><br>\n            <p>\n              Temporarily, everyone signs up.<br>\n              In the future only the admin will be responsible for registering a new employee.<br>\n              <button type=\"button\" class=\"btn btn-link\" (click)=\"newUser()\">New User? Click me</button>\n            </p>\n            <p>If you have any problem to enter or forgot your password, please contact me by email</p>\n            <p>\n              How does it work? go to the page <button type=\"button\" class=\"btn btn-link\" (click)=\"sendToAbout()\">About me.</button>\n            </p>\n        </div>\n      </div>\n    </form>\n\n</div>\n\n<app-footer></app-footer>-->\n\n"
